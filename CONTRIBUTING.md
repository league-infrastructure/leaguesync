...
Welcome to `leaguesync` contributor's guide.
...
If you experience bugs or general issues with `leaguesync`, please have a look
...
You can help improve `leaguesync` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`leaguesync` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `leaguesync`'s files. While this mechanism can
...
```
conda create -n leaguesync python=3 six virtualenv pytest pytest-cov
conda activate leaguesync
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/leaguesync.git
   cd leaguesync
   ```
...
5. Install [pre-commit]:
   ...
   `leaguesync` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/leaguesync
[issue tracker]: https://github.com/<USERNAME>/leaguesync/issues
